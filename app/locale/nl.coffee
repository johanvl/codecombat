...
#    get_course_for_class: "Assign Game Development and more to your classes!"
    request_licenses: "Neem contact op met onze school specialisten voor meer informatie."
...
#    score_display: "__scoreType__: __score__"
  ...
  inventory:
    ...
    equipped: "(gekozen)"
    locked: "(op slot)"
    restricted: "(niet beschikbaar in dit level)"
    equip: "Kies"
    unequip: "Verwijder"
#    warrior_only: "Vechter Only"
#    ranger_only: "Boswachter Only"
    wizard_only: "Alleen tovenaars"
  ...
  earn_gems:
    ...
    prompt_body: "Blijft doorspelen om meer te verdienen!"
  ...
  announcement:
    ...
    mimic_name: "Mimic"
    mimic_description: "Mimics kunnen munten oppakken voor je. Laat ze naar munten lopen om je goud voorraad te vergroten."
    cougar_name: "Poema"
    ...
    wolf_description: "Wolf puppies zijn goed in jagen, verzamelen en ze zijn heel goed in verstoppertje!"
...
#    jane_title: "Partnership Manager"
    ...
    bryukh_title: "Spel ontwikkelaar"
...
#    student_email_invite_blurb: "Your students can also use class code <strong>__classCode__</strong> when creating a Student Account, no email required."
    ...
    view_assessments: "Beoordelingen bekijken"
#    challenge: "Challenge:"
...
#    code: "__name__'s Code"
    course_not_started: "Student is nog niet met deze cursus begonnen"
    no_code_yet: "Student heeft nog geen enkele code geschreven voor dit level"
...
#    students_code_blurb: "A correct solution to each level is provided where appropriate. In some cases, it’s possible for a student to solve a level using different code. Solutions are not shown for levels the student has not started."
    ...
    help: "Help"
    language: "Taal"
    edit_class_settings: "wijzig klas instellingen"
    ...
    archived_classes_blurb: "Klassen kunnen worden gearchiveerd voor later gebruik. Dearchiveer een klas om deze weer in de lijst Huidige Klassen te zien"
    view_class: "bekijk klas"
    archive_class: "archiveer klas"
    unarchive_class: "dearchiveer klas"
    unarchive_this_class: "Dearchiveer deze klas"
...
#    ap_cs_principles_desc: "AP Computer Science Principles gives students a broad introduction to the power, impact, and possibilities of Computer Science. The course emphasizes computational thinking and problem solving while also teaching the basics of programming."
    ...
    gd3_curriculum_desc: "Lesplannen voor Game Development 3."
    wd1: "Web Ontwikkeling 1"
    ...
    student_profile: "Leerling Profiel"
...
#    teacher_quest_wakka_maul_100_step2: "See the [Arena Guide](/teachers/resources/arenas) in the [Resource Hub](/teachers/resources) for tips on how to run a successful arena day."
   teacher_quest_reach_gamedev: "Verken de nieuwe wereld!"
...
#    teacher_quest_keep_going: "Blijf doorgaan! Here's what you can do next:"
   teacher_quest_more: "Zie alle opdrachten"
   teacher_quest_less: "Zie minder opdrachten"
   refresh_to_update: "(Verves de pagina om updates te zien)"
   view_project_gallery: "Bekijk project gallerij"
...
#    mid_course: "Mid-Course"
   end_course: "Einde van de cursus"
   none: "Nog niet waargenomen"
...
#    time_played_label: "Time Played:"
  ...
  sharing:
    ...
    share_with_teacher_email: "Stuur naar jou leerkracht"
  ...
  contribute:
    ...
    ambassador_introduction: "We zijn een gemeenschap aan het uitbouwen, en jij maakt er deel van uit. We hebben Olark chatkamers, e-mails, en sociale netwerken met veel andere mensen waarmee je kan praten en hulp aan kan vragen over het spel of om bij te leren. Als jij mensen wil helpen en mee wilt werken aan de toekomst van CodeCombat , dan is dit de geknipte klasse voor jou!"
    ambassador_attribute_1: "Communicatieskills. In staat zijn problemen van spelers te herkennen en ze daarbij helpen om deze op te lossen. Verder zal je ook de rest van ons geïnformeerd houden over wat de spelers zeggen, wat ze leuk vinden, wat ze minder leuk vinden en waar er meer van moet zijn!"
    ambassador_join_desc: "vertel ons wat over jezelf, wat je hebt gedaan en wat je graag zou doen. Vanaf daar kijken we verder!"
  ...
  ladder:
    ...
    fight: "Aanvallen!"
    watch_victory: "Bekijk je overwinning!"
    ...
    winners: "Winnaars"
    league: "Competitie"
    red_ai: "Rood CPU" # "Red AI Wins", at end of multiplayer match playback
    blue_ai: "Blauw CPU"
  ...
  account:
    ...
    purchased: "Gekocht"
    subscribe_for_gems: "Abboneer voor edelstenen"
  ...
  concepts:
    ...
    algorithm_search_binary: "Algoritme Zoek Binair"
    algorithm_search_graph: "Algoritme Zoek Grafiek"
    algorithm_sort: "Algoritme Sorteer"
    algorithm_sum: "Algoritme Optellen"
    arguments: "Argumenten"
    arithmetic: "Rekenkunde"
    array_2d: "2D Reeks"
    array_index: "Reeks Indexeren"
    array_iterating: "Itereren Over Reeks"
    array_literals: "Reeks Literalen"
    array_searching: "Reeks Zoeken"
    array_sorting: "Reeks Sorteren"
    arrays: "Reeks"
    ...
    if_statements_nested: "Geneste If Statements"
    ...
    strings: "Strings"
    strings_concatenation: "Strings aaneenschakeling"
    strings_substrings: "Substring"
    trees: "Data Structuren - Boom"
    ...
    xy_coordinates: "Cartesian Coordinaten"
    ...
    create_playable_game: "Maak een speelbaar game project dat je kunt delen"
  ...
  anonymous_teacher:
   notify_teacher: "Notify docent"
   create_teacher_account: "Maak gratis docent account"
   enter_student_name: "Je naam:"
   enter_teacher_email: "je docenten email:"
   teacher_email_placeholder: "teacher.email@example.com"
   student_name_placeholder: "typ je naam hier"
   teachers_section: "docenten:"
   students_section: "studenten:"
   teacher_notified: "we hebben je docent geinformeerd dat je begonnen bent met het spelen van CodeCombat in jou klas!"
  ...
  legal:
    ...
    canonical: "De Engelse versie van dit document is de definitieve , canonical versie. Bij verschillen tussen vertalingen heeft de Engelse versie voorrang."
  ...
  ladder_prizes:
    ...
    blurb_1: "Deze prijzen worden uitgereikt volgens"
    blurb_2: "De toernooiregels"
    blurb_3: "voor de beste mens en ogre spelers."
